...
const Jiugongge = () => import(/*webpackChunkName: '"fanpaizi" */'@/pages/Market/ActTpl/Jiugongge.ActTpl')
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: '/market/actTpl/addActJiugongge', name: '翻牌子活动', component: Jiugongge, props: (router) => ({id: router.query.id})},
