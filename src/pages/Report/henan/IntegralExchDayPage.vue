<template>
    <div>
        <el-card>
            <el-row :gutter="20">
                <el-col :span="16"><div class="grid-content bg-purple">积分兑换明细日报</div></el-col>
            ...
            <el-table :data="listData" style="width: 100%" border>
                <el-table-column align="center" :label="'积分兑换明细('+ form.dt+')'">
                    <el-table-column prop="resourceName" label="资源名称"></el-table-column>
                    <el-table-column prop="cityName" label="地市"></el-table-column>
                    <el-table-column prop="integralExchangeCnt" label="本期兑奖数量"></el-table-column>
                    <el-table-column prop="addIntegralExchangeCnt" label="本年累计兑奖数量"></el-table-column>
                </el-table-column>
            </el-table>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            allTableDataList(){
                this.$request.post(`/record/henanreport/getIntegralListReportData`,this.form,true,res => {
                        let datas = res || [];
                        this.listData = datas;
                    }
                ),
            ...
            exportData(){
                var url = "/record/henanreport/importIntegralListReportData";
