<template>
    ...
    <div>
        <el-card>
            <el-row :gutter="20">
                <el-col :span="16"><div class="grid-content bg-purple">扫码数据月报</div></el-col>
                ...
                <el-row>
                    ...
                    <el-form-item label="品牌选择" size="small">
                        <el-select  v-model="selectAllBrands" placeholder="全部">
                            <el-option v-for="item in allBrandsData" :key="item.productBrand" :label="item.productBrandName" :value="item.productBrand" :multiple="true" ></el-option>
                        </el-select>
                    </el-form-item>
            ...
            <el-table :data="listData" style="width: 100%" border>
                <el-table-column align="center" :label="'扫码数据月报('+form.statTime+')'">
                    ...
                    <el-table-column prop="col7" label="截至本月末历史累计扫码量"></el-table-column>
                    <el-table-column prop="col8" label="本月通过GPS定位的扫码烟包数"></el-table-column>
                    <el-table-column prop="col9" label="本月扫码烟包数"></el-table-column>
                    <el-table-column prop="col10" label="上月扫码烟包数"></el-table-column>
                    <el-table-column prop="col11" label="截至本月末历史累计扫码烟包数"></el-table-column>
                </el-table-column>
            </el-table>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            allTableDataList(){
                this.$request.post(`/record/fixatreport/rptScanNumDateMonth`,{
            ...
            exportData(){
                var url = "/record/fixatreport/getRptScanNumDateMonthExcel";
