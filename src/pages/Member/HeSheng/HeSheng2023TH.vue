    ...
    <div >
      ...
      <el-card :body-style="{ padding: '20px' }">
        ...
        <el-form :model="info" :rules="rules" ref="ruleForm" label-width="200px" class="demo-ruleForm">
          <el-form-item label="活动ID：" prop="actCode">
            <el-input :disabled="!!info.id" v-model="info.actCode" style="width: 220px"></el-input>
          </el-form-item>
          <el-form-item label="活动结束参与时间：" prop="joinEtime">
      ...
      <el-card :body-style="{ padding: '20px' }">
        ...
        <template v-for="(ai,key) in awardConf">
          ...
          <el-form ref="awardConf" :model="ai" label-width="150px" :rules="confRules" :disabled="info.openStatus > 1">
            ...
            <el-form-item v-if="ai.awdType==7" label='折扣值：' prop="awdValue">
              <el-input-number :disabled="!!ai.id" :step="0.01" :precision="2" :min="0" :max="1"  controls-position="right" v-model="ai.awdValue"></el-input-number> 折
              <span style="margin-left: 20px">(示例：配置为0.85，即85折)</span>
            </el-form-item>
  ...
  data(){
    ...
    return {
      ...
      confRules: {
        ...
        awdName: [{ required: true, message: '请输入物料名称', trigger: 'change' }],
