...
<script>
  export default {
    ...
    methods: {
      getInfo() {
        this.$request.post('/hbact/saas/fishAct/configInfo', {}, true, res => {
          this.loading = false
          if (res.code == '200') {
      ...
      save(){
        ...
        this.$request.post('/hbact/saas/fishAct/configUpdate', params, true, res => {
          this.loading = false
          if (res.code == '200') {
      ...
      open(){
        this.$request.post('/hbact/saas/fishAct/awardOpen', {configId:this.info.id}, false, res => {
          if (res.code == '200') {
