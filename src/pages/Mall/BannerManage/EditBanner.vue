      ...
      getBannerDetail(){
        this.$request.post('/sc/saotx/mall/banner/detail',{id:this.id},true,res => {
          if (res.ret == '200000') {
            ...
            this.selectType(this.ruleForm.type)
            if(this.ruleForm.type == 1){
              this.ruleForm.productId = res.data.typeVal
            }else if(this.ruleForm.type == 2){
              this.ruleForm.link = res.data.typeVal
            }else if(this.ruleForm.type == 3){
              this.ruleForm.cateLvl1Id = res.data.cate1Id - 0
              this.ruleForm.cateLvl2Id = res.data.cate3Id - 0
              this.ruleForm.cateLvl3Id = res.data.cate3Id - 0
              this.ruleForm.cateLvl4Id = res.data.cate4Id - 0
              this.getTwoCategory()
