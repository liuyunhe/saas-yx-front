                ...
                <div class="add-tobaccomgr-form-container">
                    ...
                    <el-row>
                        <el-form-item size="small" label="库存阀值：" prop="quantity">
                            <el-input type="number"  class="tobacco-input" v-model="filters.quantity" placeholder="请输入内容" min="0" @change="checkOn2(filters.shopQuantity)"></el-input>
                        </el-form-item>
                    </el-row>
                    <el-row>
            ...
            editDeatil(pid){
                this.$request.post(`/sc/saotx/mall/product/detail`,{id:pid},true,res => {
                        ...
                        if (res.ret === '200000') {
                            ...
                            this.filters.giftType=res.data.giftType;
                            ...
                            this.filters.exchangeUrl=res.data.exchangeUrl;
