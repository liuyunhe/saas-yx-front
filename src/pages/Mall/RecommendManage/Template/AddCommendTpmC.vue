    ...
    <el-form :model="ruleForm" :inline="true" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
      <div class="add-commend-form-container">
        ...
        <el-form-item label="图1：" prop="image1" size="small">
          ...
          >
            <img v-if="ruleForm.image1" width="100" height="49" :src="ruleForm.image1" class="avatar">
            <i v-else class="el-icon-plus avatar-uploader-icon"></i>
          </el-upload>
          <div class="pic-tips">* 图片建议尺寸为 490*240px，格式为*.jpg\ *.bmp\ *.png\ *.gif</div>
        </el-form-item>
        <div></div>
        ...
        <el-form-item label="图5：" prop="image5" size="small">
          ...
          >
            <img v-if="ruleForm.image5" width="100" height="63" :src="ruleForm.image5" class="avatar">
            <i v-else class="el-icon-plus avatar-uploader-icon"></i>
          </el-upload>
          <div class="pic-tips">* 图片建议尺寸为 230*144px，格式为*.jpg\ *.bmp\ *.png\ *.gif</div>
        </el-form-item>
