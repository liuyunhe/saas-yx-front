  ...
  <section class="add-product-container">
    <el-form :model="ruleForm" :inline="true" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
      <div class="add-product-form-container">
        ...
        <div></div>
        <el-form-item label="兑换值：" prop="idx" size="small">
        ...
        <el-form-item label="选择商品：" prop="product1Name" size="small">
          <el-input v-model="ruleForm.product1Name" style="width: 200px"></el-input>
        ...
        <el-form-item label="商品2：" prop="product2Name" size="small">
          <el-input v-model="ruleForm.product2Name" style="width: 200px"></el-input>
        ...
        <el-form-item label="商品3：" prop="product3Name" size="small">
          <el-input v-model="ruleForm.product3Name" style="width: 200px"></el-input>
        ...
        <el-form-item label="商品4：" prop="product4Name" size="small">
          <el-input v-model="ruleForm.product4Name" style="width: 200px"></el-input>
...
<style>
  ...
  .add-product-container .el-table{text-align: center}
  .add-product-container .el-table th{text-align: center}
</style>
<script>
  export default {
    name: "",
      ...
      postSearchJD(params) {
        ...
        this.$request.post('/sc/saotx/mall/product/listJD', params, true, (res) => {
          if (res.ret == '200000') {
            ...
            this.filtersJD.total = res.data.page.count
            this.filtersJD.pageNo = res.data.page.pageNo
          }
        })
      },
      //从后台拿取自建商品列表
