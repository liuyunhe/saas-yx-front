<template>
    ...
    <div>
        <el-card>
            <el-row :gutter="20">
                <el-col :span="16"><div class="grid-content bg-purple">积分商城/京东订单明细</div></el-col>
            </el-row>
            <div class="space"></div>
            ...
            <el-table :data="listData" style="width: 100%" border>
                ...
                <el-table-column  label="订单状态	">
                    <template slot-scope="scope">
                        <span>{{scope.row.status == 1 ? "待收货":scope.row.status == 3 ? "已完成":scope.row.status == 0 ? "待发货": scope.row.status == 5 ? "已取消":""}}</span>
                    </template>
                </el-table-column>
