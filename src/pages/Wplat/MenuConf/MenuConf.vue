...
<script>
	export default {
		...
		methods: {
			...
			back() {
				if(this.addListShow) {
					this.addImg1 = 'http://qoss.qrmkt.cn/new_platform/pc/detail_default.png';
					this.addImg2 = 'http://qoss.qrmkt.cn/new_platform/pc/detail_default.png';
					this.editImg = 'http://qoss.qrmkt.cn/new_platform/pc/detail_default.png';
				}
				this.listShow = true;
