...
<!--            <el-button size="small" type="primary" @click="handleClickReTry">重新转账</el-button>-->
    ...
    <el-card>
      ...
      <el-table :data="tableList"  @selection-change="handleSelectionChange" style="width: 100%">
        ...
        <el-table-column prop="rebateNum" label="账户余额" align="center">
          <template slot-scope="scope">
<!--            ￥{{ scope.row.txAmount }}-->
          </template>
        </el-table-column>
        <el-table-column prop="txAmount" label="提现金额" align="center">
          <template slot-scope="scope">
            ￥{{ scope.row.txAmount }}
          </template>
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    list(_event, page, pageSize) {
      ...
      this.$request.post('/saasHbseller/sellerRebate/statics//tx/redpack/list', this.search, true, (res)=>{
