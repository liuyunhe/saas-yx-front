  ...
  <section class="basic-msg-container">
    ...
    <el-card>
      ...
      <el-form style="margin-left: 60px" label-width="100px">
        <el-form-item label="抢购人:">
          <el-input style="width: 400px" v-model="ruleForm.image"></el-input>
        </el-form-item>
    ...
    <el-card>
      ...
      <div class="contnent" style="margin-left: 60px">
        <div class="dd-line"><span>下单时间：{{  }}</span><span>订单状态：{{}}</span></div>
        <div class="dd-line"><span>取消订单时间：{{  }}</span><span>订单状态：{{}}</span></div>
        <div class="dd-line"><span>支付时间：{{  }}</span><span>订单状态：{{}}</span></div>
        <div class="dd-line"><span>发货时间：{{  }}</span><span>订单状态：{{}}</span></div>
        <div class="dd-line"><span>收货时间：{{  }}</span><span>订单状态：{{}}</span></div>
      </div>
    </el-card>
    <div class="basic-msg-form-bt">
      <el-button type="primary" @click="submitForm('ruleForm')">取消订单</el-button>
