    ...
    <div class="phone-wrapper" v-if="conf.imgObj">
      ...
      <div class="phone-body">
        <div v-if="page == 1 || page == 8">
          ...
          <img :src="conf.imgObj.page1.rulesBtn.url" class="rules-btn" @click="sendImgType(conf.imgObj.page1.rulesBtn.type)" :style="{
          ...
          <img :src="conf.imgObj.page1.drawBtn.url" alt="" class="draw-btn" @click="sendImgType(conf.imgObj.page1.drawBtn.type)" :style="{
          ...
          <div class="calendar"  @click="sendImgType(conf.imgObj.page1.calendarHeader.type)">
            <div class="header" :style="{
              ...
              'background': `url(${conf.imgObj.page1.calendarHeader.url}) no-repeat center / 100% 100%`,
              'line-height': conf.imgObj.page1.calendarHeader.size[1] * 0.4 +'px'
            }">您已经连续签到 <span>3</span> 天</div>
            <div class="con" :style="{
              ...
              'background': `url(${conf.imgObj.page1.calendarCon.url}) no-repeat center / 100% 100%`
            }">
              <div class="data-module">
                ...
                <div class="body">
                  ...
                  <div class="item" v-for="(item, i) in dayArr" :key="i" :style="signDayArr.includes(i + 1) ? conf.activeStyle : {}">{{item}}</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div v-if="page !== 1 && page < 7">
          <div class="bg" :style="{
            ...
            <img v-for="(item, index) in conf.imgObj['page' + page]" :key="index" :src="item.url" :style="{
        ...
        <div v-if="page == 7">
          <div class="share-bg">
            <div class="text">
              <h3 class="title" v-html="conf.share.shareTitle ? conf.share.shareTitle : '扫码验真'"></h3>
              <p class="desc" v-html="conf.share.shareDesc ? conf.share.shareDesc : '扫码验真精彩送不停，更多好礼等级拿！'"></p>
