      ...
      <el-form ref="ruleForm" :inline="true" :rules="rules"  :model="filters" label-width="110px">
        ...
        <div class="add-tobaccomgr-form-container">
          ...
          <el-form-item :size="'small'" label="规格名称：" prop="prodName">
            <el-input class="tobacco-input" v-model="filters.prodName" placeholder="请输入内容"></el-input>
          </el-form-item>
          <el-form-item :size="'small'" label="SN码：" prop="sn">
            <el-input class="tobacco-input" v-model="filters.sn" placeholder="请输入内容"></el-input>
          </el-form-item>
          ...
          <el-form-item :size="'small'" label="产品全称：" prop="allName">
            <el-input class="tobacco-input" v-model="filters.allName" placeholder="请输入内容"></el-input>
          </el-form-item>
...
<script>
  export default {
    ...
    methods:{
      ...
      getListGradeLevel(){
        this.$request.post('/api/wiseqr/dim/tobaccoGrade', {parentCode: this.filters.grade}, true, (res) => {
          if (res.ret == '200000') {
