      ...
      <el-col :span="24" class="toolbar" style="padding-bottom: 0px;margin-bottom: 0">
        <el-form :inline="true" :model="filters" label-width="90px">
          <el-form-item class="mr0" :size="'small'">
            <el-button type="primary" size="small" @click="querySellerFans(1)">按最后扫码时间</el-button>
            <el-button type="primary" size="small" @click="querySellerFans(2)">按扫码次数</el-button>
            <el-button type="primary" size="small" @click="querySellerFans(3)">按扫店码次数</el-button>
          </el-form-item>
        </el-form>
      </el-col>
    </div>
