        ...
        <el-tab-pane label="首页" name="home" class="clearfix">
          <div class="ipone">
            ...
            <div class="content phone">
              ...
              <div class="ship"><img :src="configItem.shipImgUrl" title="点击编辑" @click="showEditConIndex = 5"alt="" /></div>
              <div class="hook"><img :src="configItem.hookImgUrl" title="点击编辑" @click="showEditConIndex = 6"alt="" /></div>
              <div class="clock"><img :src="configItem.clockImgUrl" title="点击编辑" @click="showEditConIndex = 7"alt="" /></div>
              ...
              <div
                ...
                :class="`bubble-${item}`"
              >
                <img :src="configItem.bubbleImgUrl" title="点击编辑" @click="showEditConIndex = 8"alt="" />
              </div>
            </div>
              ...
              <div class="edit-con">
                ...
                <div class="edit-game-img" v-if="showEditConIndex == 5">
                  <div>
                    ...
                    <div class="img-con act-tip-img" style="width: 100px;height: 100px;line-height: 100px"><img :src="configItem.shipImgUrl" alt=""></div>
                    <div class="btn-con">
                      <el-upload :action="uploadURL" :headers="headerObj" :on-success="upShipImgUrlSuccess" :show-file-list="false">
                        <el-button size="small" type="primary">更换图片</el-button>
                      </el-upload>
                    </div>
                  </div>
                ...
                <div class="edit-game-img" v-if="showEditConIndex == 6">
                  <div>
                    <p class="img-title">钩子图片:</p>
                    <div class="img-con act-tip-img" style="width: 100px;height: 100px;line-height: 100px"><img :src="configItem.hookImgUrl" alt=""></div>
                    <div class="btn-con">
                      <el-upload :action="uploadURL" :headers="headerObj" :on-success="upHookImgUrlSuccess" :show-file-list="false">
                        <el-button size="small" type="primary">更换图片</el-button>
                      </el-upload>
                    </div>
                  </div>
                ...
                <div class="edit-game-img" v-if="showEditConIndex == 7">
                  <div>
                    <p class="img-title">倒计时图片:</p>
                    <div class="img-con act-tip-img" style="width: 100px;height: 100px;line-height: 100px"><img :src="configItem.clockImgUrl" alt=""></div>
                    <div class="btn-con">
                ...
                <div class="edit-game-img" v-if="showEditConIndex == 8">
                  <div>
                    <p class="img-title">红包图片:</p>
                    <div class="img-con act-tip-img" style="width: 100px;height: 100px;line-height: 100px"><img :src="configItem.bubbleImgUrl" alt=""></div>
                    <div class="btn-con">
                      <el-upload :action="uploadURL" :headers="headerObj" :on-success="upBubbleImgUrlSuccess" :show-file-list="false">
                        <el-button size="small" type="primary">更换图片</el-button>
                      </el-upload>
                    </div>
                  </div>
                ...
                <div class="edit-game-img" v-if="showEditConIndex == 9">
                  ...
                  <div>
                    ...
                    <div class="btn-con">
                      <el-upload :action="uploadURL" :headers="headerObj" :on-success="upHookLeftImgUrlSuccess" :show-file-list="false">
                        <el-button size="small" type="primary">更换图片</el-button>
                      </el-upload>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div class="btn-con">
                      <el-upload :action="uploadURL" :headers="headerObj" :on-success="upHookRightImgUrlSuccess" :show-file-list="false">
                        <el-button size="small" type="primary">更换图片</el-button>
                      </el-upload>
                    </div>
                  </div>
                ...
                <p class="tips" v-if="showEditConIndex == 5">* 图片建议尺寸为 171*124px格式为jpg\bmp\png\gif</p>
                <p class="tips" v-if="showEditConIndex == 6">* 图片建议尺寸为 61*79px格式为jpg\bmp\png\gif</p>
                <p class="tips" v-if="showEditConIndex == 7">* 图片建议尺寸为 205*119px格式为jpg\bmp\png\gif</p>
...
export default {
  ...
  data() {
    return {
      ...
      configItem: {
        ...
        bgImgUrl: 'http://qoss.qrmkt.cn/common/dhongbao/dhb-bg.png',
        actTip:'http://qoss.qrmkt.cn/common/dhongbao/dhb-tips.png',
        startImgUrl:'http://qoss.qrmkt.cn/common/dhongbao/dhb-start.png',
        shipImgUrl:'http://qoss.qrmkt.cn/common/dhongbao/dhb-ship.png',
        clockImgUrl:'http://qoss.qrmkt.cn/common/dhongbao/dhb-clock.png',
        hookImgUrl:'http://qoss.qrmkt.cn/common/dhongbao/dhb-hook.png',
        bubbleImgUrl:'http://qoss.qrmkt.cn/common/dhongbao/dhb-bubble.png',
        ...
        shareIconUrl: 'http://qoss.qrmkt.cn/common/dhongbao/share-icon.png',
  ...
  methods: {
    ...
    upShipImgUrlSuccess(resule) {
      if (resule.ret === '200000')
        return (this.configItem.shipImgUrl = resule.data.accessUrl)
      this.$message.error(resule.message)
    },
    upHookImgUrlSuccess(resule) {
      if (resule.ret === '200000')
        return (this.configItem.hookImgUrl = resule.data.accessUrl)
      this.$message.error(resule.message)
    },
    ...
    upBubbleImgUrlSuccess(resule) {
      if (resule.ret === '200000')
        return (this.configItem.bubbleImgUrl = resule.data.accessUrl)
      this.$message.error(resule.message)
    },
...
.el-tabs .el-tab-pane:first-child {
  ...
  .top:hover,.btn:hover,.ship:hover,.hook:hover,.clock:hover {
