              ...
              <div class="winning">
                <div class="prize-con">
                  ...
                  <img src="http://qrmkt.oss-cn-beijing.aliyuncs.com/saas_platform/common/model-gift.png" alt=""
                       style="position: absolute;width: 106px;height: 88px;left: 50%;transform: translateX(-50%);top: 170px">
