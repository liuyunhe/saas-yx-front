		...
		data() {
			return {
				...
				configItem: {
					title: '',
					description: '',
					headerImgUrl: 'http://qoss.qrmkt.cn/new_platform/egg-title.png',
					bgImgUrl: 'http://qoss.qrmkt.cn/new_platform/eggBg.png',
					actTip: 'http://qoss.qrmkt.cn/new_platform/egg-top.png',
					awardUrl: [{
						imgUrl: 'http://qoss.qrmkt.cn/new_platform/pc_front/zhongjiang74@2x.png'
					}],
					drawBgUrl: 'http://qoss.qrmkt.cn/new_platform/egg-award-bg.png',
					drawImgUrl: 'http://qoss.qrmkt.cn/new_platform/award_img.png',
					drawBtnUrl: 'http://qoss.qrmkt.cn/new_platform/egg-award-btn.png',
					cryImgUrl: 'http://qoss.qrmkt.cn/new_platform/egg-no-award-bg.png',
					cryBtnUrl: 'http://qoss.qrmkt.cn/new_platform/egg-no-award-btn.png'
				},
