            ...
            <el-card class="edit-img" shadow="hover">
              ...
              <div class="edit-con">
                ...
                <div class="edit-game-img" v-if="showEditConIndex == 6">
                  <div>
                    <p class="img-title">娃娃A图片:</p>
                    <div class="img-con act-tip-img" style="width: 100px;height: 100px;line-height: 100px"><img :src="configItem.toyAImgUrl" alt=""></div>
                    <div class="btn-con">
                      <el-upload :action="uploadURL" :headers="headerObj" :on-success="upToyAImgUrlSuccess" :show-file-list="false">
                        <el-button size="small" type="primary">更换图片</el-button>
                      </el-upload>
                    </div>
                  </div>
                ...
                <div class="edit-game-img" v-if="showEditConIndex == 7">
                  <div>
                    <p class="img-title">娃娃B图片:</p>
                    <div class="img-con act-tip-img" style="width: 100px;height: 100px;line-height: 100px"><img :src="configItem.toyBImgUrl" alt=""></div>
                    <div class="btn-con">
                      <el-upload :action="uploadURL" :headers="headerObj" :on-success="upToyBImgUrlSuccess" :show-file-list="false">
                        <el-button size="small" type="primary">更换图片</el-button>
                      </el-upload>
                    </div>
                  </div>
                ...
                <div class="edit-game-img" v-if="showEditConIndex == 8">
                  <div>
                    <p class="img-title">娃娃C图片:</p>
                    <div class="img-con act-tip-img" style="width: 100px;height: 100px;line-height: 100px"><img :src="configItem.toyCImgUrl" alt=""></div>
                    <div class="btn-con">
                      <el-upload :action="uploadURL" :headers="headerObj" :on-success="upToyCImgUrlSuccess" :show-file-list="false">
                        <el-button size="small" type="primary">更换图片</el-button>
                      </el-upload>
                    </div>
                  </div>
...
export default {
  ...
  data() {
    return {
      ...
      configItem: {
        title: '',
        description: '',
        headerImgUrl: 'http://qoss.qrmkt.cn/common/zhuawawa/jww-title.png',
        bgImgUrl: 'http://qoss.qrmkt.cn/common/zhuawawa/zww-bg.png',
        actTip:'http://qoss.qrmkt.cn/common/zhuawawa/jww-tips.png',
        startImgUrl:'http://qoss.qrmkt.cn/common/zhuawawa/jww-start.png',
        toysBgImgUrl:'http://qoss.qrmkt.cn/common/zhuawawa/jww-toysbg.png',
        toyAImgUrl:'http://qoss.qrmkt.cn/common/zhuawawa/jww-toyA.png',
        toyBImgUrl:'http://qoss.qrmkt.cn/common/zhuawawa/jww-toyB.png',
        toyCImgUrl:'http://qoss.qrmkt.cn/common/zhuawawa/jww-toyC.png',
        hookPoleImgUrl:'http://qoss.qrmkt.cn/common/zhuawawa/jww-hookpole.png',
        hookLeftImgUrl:'http://qoss.qrmkt.cn/common/zhuawawa/jww-hookleft.png',
        hookRightImgUrl:'http://qoss.qrmkt.cn/common/zhuawawa/jww-hookright.png',
        drawImgUrl: 'http://qoss.qrmkt.cn/common/zhuawawa/award-pop.png',
        drawBtnUrl:'http://qoss.qrmkt.cn/common/zhuawawa/award-btn.png',
        cryImgUrl: 'http://qoss.qrmkt.cn/common/zhuawawa/jww-nolucky.png',
        cryBtnUrl:'http://qoss.qrmkt.cn/common/zhuawawa/nolucky-btn.png',
        shareImgUrl: 'http://qoss.qrmkt.cn/common/zhuawawa/share-bg-img.png',
  ...
  methods: {
    ...
    upStartImgUrlSuccess(resule) {
      if (resule.ret === '200000')
        return (this.configItem.startImgUrl = resule.data.accessUrl)
      this.$message.error(resule.message)
    },
    upToyAImgUrlSuccess(resule) {
      if (resule.ret === '200000')
        return (this.configItem.toyAImgUrl = resule.data.accessUrl)
      this.$message.error(resule.message)
    },
    upToyBImgUrlSuccess(resule) {
      if (resule.ret === '200000')
        return (this.configItem.toyBImgUrl = resule.data.accessUrl)
      this.$message.error(resule.message)
    },
    upToyCImgUrlSuccess(resule) {
      if (resule.ret === '200000')
