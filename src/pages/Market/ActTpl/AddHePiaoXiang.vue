        ...
        <el-tab-pane label="首页" name="home" class="clearfix">
          <div class="ipone">
            ...
            <div class="content phone">
              ...
              <div class="wateringcan"><img :src="configItem.wateringcanImgUrl" title="点击编辑" @click="showEditConIndex = 5"alt="" /></div>
              <div class="flower"><img :src="configItem.flowerImgUrl1" title="点击编辑" @click="showEditConIndex = 7"alt="" /></div>
            </div>
              ...
              <div class="edit-con">
                ...
                <div class="edit-game-img" v-if="showEditConIndex == 3">
                  <div>
                    ...
                    <div class="btn-con">
                      <el-upload :action="uploadURL" :headers="headerObj" :on-success="upStartImgUrlSuccess" :show-file-list="false">
                        <el-button size="small" type="primary">更换图片</el-button>
                      </el-upload>
                    </div>
                  </div>
                ...
                <div class="edit-game-img" v-if="showEditConIndex == 5">
                  <div>
                    <p class="img-title">水壶图片:</p>
                    <div class="img-con act-tip-img" style="width: 100px;height: 100px;line-height: 100px"><img :src="configItem.wateringcanImgUrl" alt=""></div>
                    <div class="btn-con">
                      <el-upload :action="uploadURL" :headers="headerObj" :on-success="upWateringcanImgUrlSuccess" :show-file-list="false">
                        <el-button size="small" type="primary">更换图片</el-button>
                      </el-upload>
                    </div>
                  </div>
                ...
                <div class="edit-game-img" v-if="showEditConIndex == 7">
                  <div>
                    <p class="img-title">花朵图片-状态1:</p>
                    <div class="img-con act-tip-img" style="width: 100px;height: 100px;line-height: 100px"><img :src="configItem.flowerImgUrl1" alt=""></div>
                    <div class="btn-con">
                      <el-upload :action="uploadURL" :headers="headerObj" :on-success="upFlowerImgUrlSuccess1" :show-file-list="false">
                        <el-button size="small" type="primary">更换图片</el-button>
                      </el-upload>
                    </div>
                  </div>
                  <div>
                    <p class="img-title">花朵图片-状态2:</p>
                    <div class="img-con act-tip-img" style="width: 100px;height: 100px;line-height: 100px"><img :src="configItem.flowerImgUrl2" alt=""></div>
                    <div class="btn-con">
                      <el-upload :action="uploadURL" :headers="headerObj" :on-success="upFlowerImgUrlSuccess2" :show-file-list="false">
                        <el-button size="small" type="primary">更换图片</el-button>
                      </el-upload>
                    </div>
                  </div>
                  <div>
                    <p class="img-title">花朵图片-状态3:</p>
                    <div class="img-con act-tip-img" style="width: 100px;height: 100px;line-height: 100px"><img :src="configItem.flowerImgUrl3" alt=""></div>
                    <div class="btn-con">
                      <el-upload :action="uploadURL" :headers="headerObj" :on-success="upFlowerImgUrlSuccess3" :show-file-list="false">
                        <el-button size="small" type="primary">更换图片</el-button>
                      </el-upload>
                    </div>
                  </div>
                  <div>
                    <p class="img-title">花朵图片-状态4:</p>
                    <div class="img-con act-tip-img" style="width: 100px;height: 100px;line-height: 100px"><img :src="configItem.flowerImgUrl4" alt=""></div>
                    <div class="btn-con">
                      <el-upload :action="uploadURL" :headers="headerObj" :on-success="upFlowerImgUrlSuccess4" :show-file-list="false">
                        <el-button size="small" type="primary">更换图片</el-button>
                      </el-upload>
                    </div>
                  </div>
                  <div>
                    <p class="img-title">花朵图片-状态5:</p>
                    <div class="img-con act-tip-img" style="width: 100px;height: 100px;line-height: 100px"><img :src="configItem.flowerImgUrl5" alt=""></div>
                    <div class="btn-con">
                      <el-upload :action="uploadURL" :headers="headerObj" :on-success="upFlowerImgUrlSuccess5" :show-file-list="false">
                        <el-button size="small" type="primary">更换图片</el-button>
                      </el-upload>
                    </div>
                  </div>
                ...
                <p class="tips" v-if="showEditConIndex == 7">* 图片建议尺寸为 900*658px格式为jpg\bmp\png\gif</p>
                <p class="tips" v-if="showEditConIndex == 8">* 图片建议尺寸为 400*400px格式为jpg\bmp\png\gif</p>
              </div>
...
export default {
  ...
  data() {
    return {
      ...
      configItem: {
        ...
        flowerImgUrl2:'https://qrmkt.oss-cn-beijing.aliyuncs.com/common/hepiaoxiang/hehua-2.png',
        flowerImgUrl3:'https://qrmkt.oss-cn-beijing.aliyuncs.com/common/hepiaoxiang/hehua-3.png',
  ...
  methods: {
    ...
    // 上传抽奖按钮图片
    upToysBgImgUrlSuccess(resule) {
      if (resule.ret === '200000')
        return (this.configItem.toysBgImgUrl = resule.data.accessUrl)
      this.$message.error(resule.message)
    },

    upWateringcanImgUrlSuccess(resule) {
      if (resule.ret === '200000')
        return (this.configItem.wateringcanImgUrl = resule.data.accessUrl)
      this.$message.error(resule.message)
    },
    upFlowerImgUrlSuccess1(resule) {
      if (resule.ret === '200000')
        return (this.configItem.flowerImgUrl1 = resule.data.accessUrl)
      this.$message.error(resule.message)
    },
    upFlowerImgUrlSuccess2(resule) {
      if (resule.ret === '200000')
        return (this.configItem.flowerImgUrl2 = resule.data.accessUrl)
      this.$message.error(resule.message)
    },
    upFlowerImgUrlSuccess3(resule) {
      if (resule.ret === '200000')
        return (this.configItem.flowerImgUrl3 = resule.data.accessUrl)
      this.$message.error(resule.message)
    },
    upFlowerImgUrlSuccess4(resule) {
      if (resule.ret === '200000')
        return (this.configItem.flowerImgUrl4 = resule.data.accessUrl)
      this.$message.error(resule.message)
    },
    upFlowerImgUrlSuccess5(resule) {
      if (resule.ret === '200000')
        return (this.configItem.flowerImgUrl5 = resule.data.accessUrl)
      this.$message.error(resule.message)
    },
...
.el-tabs .el-tab-pane:first-child {
  ...
  .top:hover,.btn:hover,.hook:hover,.flower:hover {
