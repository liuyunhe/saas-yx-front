  ...
  data() {
    return {
      ...
      configItem: {
        title: '',
        description: '',
        getBtn: 'http://qoss.qrmkt.cn/new_platform/zuan_award_btn.png',
        award_bg:'http://qoss.qrmkt.cn/new_platform/zuan_award_bg.png',
        knowBtn: 'http://qoss.qrmkt.cn/new_platform/zuan_no_award_btn.png',
        headerImgUrl:
          'http://qoss.qrmkt.cn/new_platform/pc_front/zuanshi-header.png',
        bgImgUrl: 'http://qoss.qrmkt.cn/new_platform/pc_front/zuanshi-bg.png',
        kitsUrl: 'http://qoss.qrmkt.cn/new_platform/fanzuanshi-tips.png',
        iconUrl: [
          {
            key: 1,
            imgUrl: 'http://qoss.qrmkt.cn/new_platform/pc_front/zuanshi.png',
            $$hashKey: 'object:378'
          },
          {
            key: 2,
        ...
        iconAwardImg: 'http://qoss.qrmkt.cn/new_platform/pc_front/zuanshi.png',
        awardUrl: [
          {
            imgUrl:
